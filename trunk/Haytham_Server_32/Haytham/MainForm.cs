...
namespace Haytham
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void gestureIcons(object sender, HeadGestureEventArgs e)
        {
            ...
            if ((string)btnBlink.Tag == e.Gesture) { btnBlink.BackColor = Color.Pink;

            if (METState.Current.TextFileDataExport != null) METState.Current.TextFileDataExport.temp1 ="1";
            }
            if ((string)btnDbBlink.Tag == e.Gesture) { btnDbBlink.BackColor = Color.Pink;
        ...
        private void cmbDeviceEye_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cmbDeviceEye.SelectedItem.ToString() != "Video file" )
            {
                ...
                if (cmbDeviceEye.SelectedItem != null)
                {
                    ...
                    if (cmbDeviceCapabilityEye.Items.Count>0)
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (METState.Current.EyeIsRecording)
                    {
                        ...
                        {
                            btn_RecordProgress.Enabled = true;
                            btn_RecordProgress.Text = "Record Videos and EyeData";
                        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (METState.Current.SceneIsRecording)
                    {
                        ...
                        {
                            btn_RecordProgress.Enabled = true;
                            btn_RecordProgress.Text = "Record Videos and SceneData";
                        }
        ...
        private void btn_Record_Click(object sender, EventArgs e)
        {
            ...
            if (METState.Current.SceneIsRecording == false & METState.Current.EyeIsRecording == false)// Record
            {
                ...
                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        if (((METState.Current.SceneCamera != null && METState.Current.SceneCamera.IsRunning) | METState.Current.SceneVideoFile != null)&&METState.Current.SceneForExport)
                        {
                        ...
                        if (((METState.Current.EyeCamera != null && METState.Current.EyeCamera.IsRunning) | METState.Current.EyeVideoFile != null)&&METState.Current.EyeForExport )
                        {
