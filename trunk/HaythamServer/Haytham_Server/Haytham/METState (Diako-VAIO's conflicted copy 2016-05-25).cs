...
namespace Haytham
{
    ...
    public sealed class METState
    {
        ...
        public ManualResetEvent camera1Acquired = null;
        ...
        public Image<Bgr, Byte> EyeImageTest;
        ...
        //Recording
        public VideoFileWriter SceneVideoWriter;//Recording SceneImageForShow
        public long SceneVideoWriterFrameNumber;
        public VideoFileWriter EyeVideoWriter;//Recording EyeImageForShow
