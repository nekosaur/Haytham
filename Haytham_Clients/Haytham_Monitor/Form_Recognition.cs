...
namespace Haytham_Client
{
    public partial class Form_Recognition : Form
    {
        ...
        public Form_Recognition(Form_monitor frm, Rectangle rect)
        {
            InitializeComponent();
            ...
            Bitmap bmp = new Bitmap(assembly.GetManifestResourceStream(string.Format("Haytham_Client.Images.{0}.png", ClientStatus.clientIndex)));
