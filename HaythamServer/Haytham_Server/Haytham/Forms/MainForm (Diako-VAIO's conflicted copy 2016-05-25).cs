    ...
    public partial class MainForm : Form
    {
        ...
        private void btnEyeStart_Click(object sender, EventArgs e)
        {
            if (btnStartEye.Text == "Start")
            {
                ...
                if (cam.Name == "Video file eye") cam.ShowSettings();
                ...
                METState.Current.camera1Acquired = new ManualResetEvent(true);

                if (cam.Name != "Video file eye")
                {
                    cam.Start();
        ...
        private void btnSceneStart_Click(object sender, EventArgs e)
        {
            ...
            if (btnStartScene.Text == "Start")
            {
                ...
                if (cam.Name == "Video file scene") cam.ShowSettings();
                ...
                if (METState.Current.METCoreObject.LoadCameraCalibrationData())
                {
                    ...
                    try
                    {
                        ...
                        if (cam is VideoSource.AforgeVideoSource || cam is VideoSource.FileVideoSource_eye)
                        {
        ...
        private void button1_Click_5(object sender, EventArgs e)
        {
            ...
            //}
            if (btnStartEye.Text == "Start" && METState.Current.EyeCamera != null)
                METState.Current.EyeCamera.Stop();
            if (btnStartScene.Text == "Start" && METState.Current.SceneCamera != null)
                METState.Current.SceneCamera.Stop();
                ...
                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                        if (((METState.Current.SceneCamera != null && METState.Current.SceneCamera.IsRunning)) && METState.Current.SceneForExport)
                        {
                            ...
                            METState.Current.SceneVideoWriter = new VideoFileWriter();//15?? it dependes on fps of the videos 
                            METState.Current.SceneVideoWriterFrameNumber = 0;
                            
                           
                            METState.Current.SceneVideoWriter.Open(dir,  SceneW, SceneH, 19, VideoCodec.Default, 5000000);
                        ...
                        if (((METState.Current.EyeCamera != null && METState.Current.EyeCamera.IsRunning)) && METState.Current.EyeForExport)
                        {
                            ...
                            METState.Current.EyeVideoWriter =new VideoFileWriter();
                            METState.Current.EyeVideoWriterFrameNumber = 0;
                            METState.Current.EyeVideoWriter.Open(newdir, EyeW, EyeH, 19, VideoCodec.Default, 5000000);
                        }
                    }
                    ...
                    if (codecOK)
                    {
                       ...
                       // METState.Current.DataHandler.OpenLog(dir + ".obd.csv");
                        ...
                        if (((METState.Current.EyeCamera != null && METState.Current.EyeCamera.IsRunning)) && METState.Current.EyeForExport)
                        {
                            ...
                            METState.Current.EyeVideoWriter.WriteVideoFrame(EyeRED.Bitmap);
                        ...
                        if ((METState.Current.SceneCamera != null && METState.Current.SceneCamera.IsRunning) && METState.Current.SceneForExport)
                        {
                            ...
                            METState.Current.SceneVideoWriter.WriteVideoFrame(SceneRED.Bitmap);
